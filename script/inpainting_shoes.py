...
mask_image = Image.open("/home/dong/projects/sd/template_images/template_mask_shoes.jpg")  # 마스크 (교체할 부분)
input_image = Image.open("/home/dong/projects/sd/input/input_shoes_2.jpg")  # ip-adapter 참조 이미지
...
# 마스크 이미지에 블러 적용
blurred_mask = pipeline.mask_processor.blur(mask_image, blur_factor=15)
