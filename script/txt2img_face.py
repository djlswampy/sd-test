...
# 프롬프트 설정
prompt = "mbas, Cartoons, Anime, masterpiece, high_quality_anime, super detail, hyper detail, animation, anime_art_style, " \
"Handsome man with a short, subtle beard only on his chin and a sporty haircut, realistic details, natural lighting, close-up portrait."
