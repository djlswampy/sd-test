...
mask_image = Image.open("/home/dong/projects/sd/template_images/template_mask_bottom.jpg")  # 마스크 (교체할 부분)
input_image = Image.open("/home/dong/projects/sd/input/input_bottom_1.jpg")  # ip-adapter 참조 이미지
